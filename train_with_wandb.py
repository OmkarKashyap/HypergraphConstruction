...
#     trainset = SentenceDataset(args.dataset_file['train'], args, config, vocab_help)
#     testset = SentenceDataset(args.dataset_file['test'], args, config, vocab_help)
...
#     optimizer = Optim.optimizers[args.optim](model.parameters(), args.learning_rate)
...
#     parser.add_argument('--optim', choices=['rmsprop', 'adagrad', 'adam', 'adamax'], default='rmsprop', help='Optimizer: sgd, adagrad, adam or adamax.')
...
def main():
    ...
    sweep_id = wandb.sweep(sweep_config, project="KNN-hypergraph")
