...
def train_and_evaluate(args, num_epoch, learning_rate, batch_size, dropout_rate, writer):
...
def hyperparameter_tuning(args):
    ...
    search_space = {
        'num_epoch': [1,10, 20],
        'learning_rate': [0.5,0.1, 0.02, 0.001, 0.0001],
        ...
        for learning_rate in search_space['learning_rate']:
            for batch_size in search_space['batch_size']:
                for dropout_rate in search_space['dropout_rate']:
                    ...
                    max_test_acc, max_f1 = train_and_evaluate(args, num_epoch, learning_rate, batch_size, dropout_rate, writer)
